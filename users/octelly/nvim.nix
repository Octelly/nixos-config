        ...
        colorizer = {
          ...
          settings = {
            ...
            user_default_options = {
              ...
              mode = "virtualtext";
              virtualtext = "󱓻";
              virtualtext_inline = mkRaw "'before'";
            };
          };
        };
        ...
        cmp = {
          ...
          settings = {
            ...
            formatting = {
              ...
              format =
                let
                  skipFirst = num: string: (builtins.substring num (builtins.stringLength string) string);
                in
                lib.mkForce (
                  # disgusting hack
                  # moonscript will force the compiled function to be returned
                  # we just remove the first 7 chars: "return "
                  skipFirst 7 (
                    builtins.readFile (
                      pkgs.stdenv.mkDerivation {
                        name = "cmp-formatting-format";
                        src = ./cmp-formatting-format.moon;
